...
Alternatively, CoordinateCleaner includes an example dataset, downloaded from paleobioDB as specified above. We will use thisone for now.

```{r, eval = F, collapse = TRUE, echo = F}
data(pbdb_example)
dat <- pbdb_example
rownames(dat) <- NULL
```
