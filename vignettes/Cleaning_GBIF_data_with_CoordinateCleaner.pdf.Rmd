...
local <- T # this defines if the vignette is build locally using a largelocal dataset or not, in which case the compilation will take very long
```
...
```{r, echo = T, eval = -12, warning = F, message = F}
library(tidyverse)
library(rgbif)
library(countrycode)
...
<!-- ```{r, echo = F, eval = local, warning = F, message = F} -->
