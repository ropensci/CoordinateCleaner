...
```{r, echo = F, eval = !nzchar(Sys.getenv("vignette_local")), warning = F, message = F}
library(dplyr)
library(ggplot2)
library(rgbif)
library(sp)
...
```{r, echo = T, eval = nzchar(Sys.getenv("vignette_local")), warning = F, message = F}
library(dplyr)
library(ggplot2)
library(rgbif)
library(sp)
...
```{r, eval = TRUE, warnings = F, message = F, fig.height = 6}
